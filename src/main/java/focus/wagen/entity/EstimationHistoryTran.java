...
/**
 * The persistent class for the estimation_history_tran database table.
 * 
 */
@Entity
@Table(name="estimation_history_tran")
@NamedQuery(name="EstimationHistoryTran.findAll", query="SELECT e FROM EstimationHistoryTran e")
public class EstimationHistoryTran implements Serializable {
