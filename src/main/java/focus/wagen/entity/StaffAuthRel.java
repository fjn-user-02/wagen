...
/**
 * The persistent class for the staff_auth_rel database table.
 * 
 */
@Entity
@Table(name="staff_auth_rel")
@NamedQuery(name="StaffAuthRel.findAll", query="SELECT s FROM StaffAuthRel s")
public class StaffAuthRel implements Serializable {
